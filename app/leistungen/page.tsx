        ...
        <section className="py-12 sm:py-16 bg-background">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <Button
              asChild
              size="lg"
              className="bg-accent hover:bg-accent/90 text-accent-foreground font-semibold px-8 py-6 h-auto text-lg transition-all duration-200 hover:scale-105 group flex flex-col items-center gap-1"
            >
              <a
              ...
              >
                <span className="text-center">
                  <div>Jetzt Service anfragen</div>
                  <div className="text-sm opacity-90">перейти в WhatsApp</div>
                </span>
