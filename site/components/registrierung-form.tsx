    ...
    <div className="bg-card dark:bg-[#1a2420] rounded-2xl shadow-lg p-8">
      <div className="space-y-4">
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h4 className="font-semibold text-foreground">Ich suche einen Job</h4>
        ...
        <button
          ...
          className="group w-full bg-card dark:bg-[#1a2420] rounded-2xl p-8 border-2 border-border hover:border-primary transition-all duration-300 text-left cursor-pointer"
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h4 className="font-semibold text-foreground mb-2">Handwerksunternehmen</h4>
              <p className="text-sm text-muted-foreground">Sie haben ein Team und möchten Aufträge für Ihre Firma erhalten.</p>
            </div>
          </div>
        </button>
      </div>
